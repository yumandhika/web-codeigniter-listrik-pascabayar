<html>
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>PP</b>OB</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>PPOB</b> Pascabayar</span>
    </a>
    ...
    <section class="sidebar" style="height: auto;">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <p>Saldo Rp.<?php foreach($this->session->userdata('adminSession') as $a){echo number_format($a->saldo,0,",",",") ;}?><p>
        </div>
      </div>
      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        ...
        <li class="treeview <?php if($title == 'Home' || $title == 'Admin'){echo "active menu-open";}else{}?>">
          ...
          <ul class="treeview-menu">
            <li class="<?php if($title == 'Home'){echo "active";}else{}?>"><a href="/listrik-pascabayar/ppob/home"><i class="fa fa-circle-o"></i>Pelanggan</a></li>
          </ul>
        </li>
        <li class="treeview <?php if($title == 'Penggunaan' || $title == 'Tagihan' || $title == 'Pembayaran' || $title == 'Tarif'){echo "active menu-open";}else{}?>">
          ...
          <ul class="treeview-menu">
            <li class="<?php if($title == 'Tagihan'){echo "active";}else{}?>"><a href="/listrik-pascabayar/ppob/tagihan"><i class="fa fa-circle-o"></i>Tagihan</a></li>
          </ul>
        </li>
