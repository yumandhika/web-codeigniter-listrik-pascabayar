 ...
 <div class="content-wrapper" style="min-height: 916px;">
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="../../ppob/pembayaran/update" method="POST">
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="id_saldo" value="<?php foreach($this->session->userdata('adminSession') as $a){echo $a->id_saldo ;}?>" class="form-control" placeholder="Enter ..." readonly style="position:absolute;visibility:hidden;">
                                <input type="text" name="saldo" value="<?php foreach($this->session->userdata('adminSession') as $a){echo $a->saldo ;}?>" class="form-control" placeholder="Enter ..." readonly style="position:absolute;visibility:hidden;">
                                <input type="text" name="nama_pelanggan" value="<?php echo $tagihanbayar[0]['nama_pelanggan']?>" class="form-control" placeholder="Enter ..." readonly>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nomor_kwh"  value="<?php echo $tagihanbayar[0]['nomor_kwh']?>" class="form-control" placeholder="Enter ..." readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                <label>daya</label>
                                <input type="text" name="daya" value="<?php echo $tagihanbayar[0]['daya']?>" class="form-control" placeholder="Enter ..." readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                <label>Tarif/kwh</label>
                                <input type="text" name="tarifperkwh" value="Rp.<?php echo number_format($tagihanbayar[0]['tarifperkwh'],0,',',',')?>" class="form-control" placeholder="Enter ..." readonly>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                <label>Alamat</label>
                                <input type="text" name="alamat" value="<?php echo $tagihanbayar[0]['alamat']?>" class="form-control" placeholder="Enter ..." readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="jumlah_meter" value="<?php echo $tagihanbayar[0]['jumlah_meter']?>" class="form-control" placeholder="Enter ..." readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
