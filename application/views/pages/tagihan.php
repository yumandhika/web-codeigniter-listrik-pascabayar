            ...
            <div class="box-body">
              ...
              <table id="myTable" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tr role="row" class="odd">
                  ...
                  <td><a href="<?php if($tagihan->status=="sudah bayar"){echo "#";}elseif($tagihan->status=="belum bayar"){echo "tagihan/bayar/".$tagihan->id_tagihan;}else{echo "#";}?>"><button type="button" class="btn btn-block <?php if($tagihan->status=="sudah bayar"){echo "btn-success";}elseif($tagihan->status=="belum bayar"){echo "btn-danger";}else{echo "btn-warning";}?>"><?php echo $tagihan->status ?></button></a></td>
                </tr>
                <?php } ?>
              </table>
            </div>
